...
class Cena_principal:
  ...
  def atualiza_estado(self):
      ...
      self.jogador1.poder.efeito([[self.jogador2],self.minions],self.jogador1,self.agora)
      self.jogador2.poder.efeito([[self.jogador1],self.minions],self.jogador2,self.agora)
